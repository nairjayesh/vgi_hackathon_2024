def get_icon_url(passengers):
    ...
    # if passengers == '1' or passengers == '2' or passengers == '3' or passengers == '4' or passengers == '5':
    #     return low_demand_icon
    # elif passengers == '6' or passengers == '7' or passengers == '8' or passengers == '9' or passengers == '10':
